...
- 📦 **Box shortcuts** — click a box heading to mark every Pokémon in that box at once.
- 📊 **Progress bar** — shows how many you've caught out of the total, with a percentage.
- 💾 **Persistent** — your progress is saved in browser storage and survives page refreshes.
...
| Reset all progress | Click **Reset** in the progress bar and confirm |
